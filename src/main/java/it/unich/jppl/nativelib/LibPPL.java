...
public final class LibPPL {
    ...
    // not actually supported by the C interface
    ...
    public static native int ppl_new_C_Polyhedron_from_C_Polyhedron_with_complexity (PointerByReference pph, Pointer ph, int complexity);
    ...
    public static native int ppl_new_C_Polyhedron_from_NNC_Polyhedron_with_complexity (PointerByReference pph, Pointer ph, int complexity);

    public static native int ppl_new_NNC_Polyhedron_from_space_dimension(PointerByReference pph, Dimension d, int empty);
    public static native int ppl_new_NNC_Polyhedron_from_NNC_Polyhedron (PointerByReference pph, Pointer ph);
    public static native int ppl_new_NNC_Polyhedron_from_NNC_Polyhedron_with_complexity (PointerByReference pph, Pointer ph, int complexity);
    ...
    public static native int ppl_new_NNC_Polyhedron_from_C_Polyhedron_with_complexity (PointerByReference pph, Pointer ph, int complexity);
    ...
    public static native int ppl_Polyhedron_maximize_with_point (Pointer ph, Pointer le, Pointer sup_n, Pointer sup_d, IntByReference pmaximum, Pointer point);
    public static native int ppl_Polyhedron_maximize (Pointer ph, Pointer le, Pointer sup_n, Pointer sup_d,  IntByReference pmaximum);
    public static native int ppl_Polyhedron_minimize_with_point (Pointer ph, Pointer le, Pointer inf_n, Pointer inf_d, IntByReference pminimum, Pointer point);
    public static native int ppl_Polyhedron_minimize (Pointer ph, Pointer le, Pointer inf_n, Pointer inf_d, IntByReference pminimum);
    ...
    public static native int ppl_Polyhedron_bounded_affine_image (Pointer ph, Dimension var, Pointer lb, Pointer ub, Pointer d);
    public static native int ppl_Polyhedron_bounded_affine_preimage (Pointer ph, Dimension var, Pointer lb, Pointer ub, Pointer d);
    public static native int ppl_Polyhedron_generalized_affine_image (Pointer ph, Dimension var, int relsym, Pointer le, Pointer d);
    public static native int ppl_Polyhedron_generalized_affine_preimage (Pointer ph, Dimension var, int relsym, Pointer le, Pointer d);
    public static native int ppl_Polyhedron_generalized_affine_image_lhs_rhs (Pointer ph, Pointer lhs, int relsym, Pointer rhs);
    public static native int ppl_Polyhedron_generalized_affine_preimage_lhs_rhs (Pointer ph, Pointer lhs, int relsym, Pointer rhs);
    ...
    public static native int ppl_Polyhedron_limited_BHRZ03_extrapolation_assign_with_tokens (Pointer x, Pointer y, Pointer cs, IntByReference tp);
    public static native int ppl_Polyhedron_limited_H79_extrapolation_assign_with_tokens (Pointer x, Pointer y, Pointer cs, IntByReference tp);
    ...
    public static native int ppl_Polyhedron_bounded_BHRZ03_extrapolation_assign_with_tokens (Pointer x, Pointer y, Pointer cs, IntByReference tp);
