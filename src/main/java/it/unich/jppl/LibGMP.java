...
final class LibGMP {
    ...
    static native void __gmpz_set_ui(Pointer rop, long op);
    static native void __gmpz_set_si(Pointer rop, long op);
    ...
    static native void __gmpz_init_set_ui(Pointer rop, long op);
    static native void __gmpz_init_set_si(Pointer rop, long op);
    ...
    static native long __gmpz_get_ui(Pointer op);
    static native long __gmpz_get_si(Pointer op);
    static native double __gmpz_get_d(Pointer op);
    static native double __gmpz_get_d_2exp(Pointer exp, long op);
    ...
    static native void __gmpz_add_ui(Pointer rop, Pointer op1, long op2);
    static native void __gmpz_sub(Pointer rop, Pointer op1, Pointer op2);
    static native void __gmpz_sub_ui(Pointer rop, Pointer op1, long op2);
    static native void __gmpz_ui_sub(Pointer rop, long op1, Pointer op2);
    static native void __gmpz_mul(Pointer rop, Pointer op1, Pointer op2);
    static native void __gmpz_mul_si(Pointer rop, Pointer op1, long op2);
    static native void __gmpz_mul_ui(Pointer rop, Pointer op1, long op2);
    static native void __gmpz_addmul(Pointer rop, Pointer op1, Pointer op2);
    static native void __gmpz_addmul_ui(Pointer rop, Pointer op1, long op2);
    static native void __gmpz_submul(Pointer rop, Pointer op1, Pointer op2);
    static native void __gmpz_submul_ui(Pointer rop, Pointer op1, long op2);
    static native void __gmpz_mul_2exp(Pointer rop, Pointer op1, long op2);  // mp_bitcnt_r
    ...
    static native long __gmpz_cdiv_q_ui(Pointer q, Pointer n, long d);
    static native long __gmpz_cdiv_r_ui(Pointer r, Pointer n, long d);
    static native long __gmpz_cdiv_qr_ui(Pointer q, Pointer r, Pointer n, long d);
    static native long __gmpz_cdiv_ui(Pointer n, long d);
    static native void __gmpz_cdiv_q_2exp(Pointer q, Pointer n, long b); // mp_bitcnt_r
    static native void __gmpz_cdiv_r_2exp(Pointer r, Pointer n, long b); // mp_bitcnt_r
    ...
    static native long __gmpz_fdiv_q_ui(Pointer q, Pointer n, long d);
    static native long __gmpz_fdiv_r_ui(Pointer r, Pointer n, long d);
    static native long __gmpz_fdiv_qr_ui(Pointer q, Pointer r, Pointer n, long d);
    static native long __gmpz_fdiv_ui(Pointer n, long d);
    static native void __gmpz_fdiv_q_2exp(Pointer q, Pointer n, long b); // mp_bitcnt_r
    static native void __gmpz_fdiv_r_2exp(Pointer r, Pointer n, long b); // mp_bitcnt_r
    ...
    static native long __gmpz_tdiv_q_ui(Pointer q, Pointer n, long d);
    static native long __gmpz_tdiv_r_ui(Pointer r, Pointer n, long d);
    static native long __gmpz_tdiv_qr_ui(Pointer q, Pointer r, Pointer n, long d);
    static native long __gmpz_tdiv_ui(Pointer n, long d);
    static native void __gmpz_tdiv_q_2exp(Pointer q, Pointer n, long b); // mp_bitcnt_r
    static native void __gmpz_tdiv_r_2exp(Pointer r, Pointer n, long b); // mp_bitcnt_r

    static native void __gmpz_powm(Pointer rop, Pointer base, Pointer exp, Pointer mod);
    static native void __gmpz_powm_ui(Pointer rop, Pointer base, long exp, Pointer mod);
    static native void __gmpz_powm_sec(Pointer rop, Pointer base, Pointer exp, Pointer mod);
    static native void __gmpz_pow_ui(Pointer rop, Pointer base, long exp);
    static native void __gmpz_ui_pow_ui(Pointer rop, long base, long exp);

    static native void __gmpz_root(Pointer rop, Pointer op, long n);
    static native void __gmpz_rootrem(Pointer rop, Pointer op, long n);
    ...
    static native int __gmpz_cmpabs_ui(Pointer op1, long op2);
	...
	*/
    ...
    static native long __gmpz_sizeinbase(Pointer op, int base);
