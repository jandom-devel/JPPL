 ...
 */
public class PPLError extends RuntimeException {
    ...
    PPLError(int code) {
        super("PPL ERROR " + ERROR_STRINGS[-code] + " : " + JPPLErrorHandler.description);
        this.code = code;
    }

    PPLError(int code, String description) {
        super(description);
        this.code = code;
    }
